...
public class DashRendererBuilder implements RendererBuilder {
    ...
    private static final class AsyncRendererBuilder implements ManifestCallback<MediaPresentationDescription>, UtcTimingCallback {
        ...
        private void buildRenderers() {
            ...
            TrackRenderer audioRenderer = new MediaCodecAudioTrackRenderer(new ChunkSampleSource(new DashChunkSource(this.manifestFetcher, DefaultDashTrackSelector.newAudioInstance(), defaultUriDataSource, null, 30000, this.elapsedRealtimeOffset, mainHandler, this.player, 1), defaultLoadControl, 3538944, mainHandler, this.player, 1), MediaCodecSelector.DEFAULT, drmSessionManager, true, mainHandler, this.player, AudioCapabilities.getCapabilities(this.context), 3);
            ...
            TextTrackRenderer textTrackRenderer = new TextTrackRenderer((SampleSource) new ChunkSampleSource(new DashChunkSource(this.manifestFetcher, DefaultDashTrackSelector.newTextInstance(), defaultUriDataSource2, null, 30000, this.elapsedRealtimeOffset, mainHandler, this.player, 2), defaultLoadControl, 131072, mainHandler, this.player, 2), (TextRenderer) this.player, mainHandler.getLooper(), new SubtitleParser[0]);
